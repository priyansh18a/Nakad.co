...
export async function updateTier1PayableReceivable(req: Request, res: Response): Promise<Response<AnchorTier2InvoiceMapping>> {
  ...
  if(request.tier1ReceivableEntry === "Nochange") anchorTier2InvoiceMapping.tier1PayableEntry = request.tier1PayableEntry;
  if(request.tier1PayableEntry === "Nochange") anchorTier2InvoiceMapping.tier1ReceivableEntry = request.tier1ReceivableEntry;
