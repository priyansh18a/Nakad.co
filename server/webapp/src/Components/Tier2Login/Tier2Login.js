         ...
         <form onSubmit={logintier2}> 
            <div className="field">
                <div className="control">
                    ...
                    <input className="input" type="text" name="companyid" placeholder="Company ID" value={form.companyid} onChange={update} required/>
                </div>
            </div>
            <div className="field">
                <div className="control">
            ...
            <div className="field">
                ...
                <a class="help has-text-left" href="/tier2">Forgot Company ID / User ID / Password</a>
            </div>
             <div className="field is-grouped is-grouped-centered">
                <div className="buttons">
                    <button className="is-info  button " onClick={() => console.log(form)}>Login</button>
                </div>
            </div>
            </form>
            </div>
